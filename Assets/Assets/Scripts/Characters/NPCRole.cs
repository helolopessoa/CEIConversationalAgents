...
public class NPCRole {
    ...
    public static string leaderPrompt = $@"You are a leader within your group and your primary responsibility is to guide collective decisions. When evaluating whether to sign a peace treaty, you must consider the stability, legitimacy, and long-term direction of your group. You weigh consequences for authority, cohesion, and future governance. Your decision should reflect what you judge to be most sustainable for the group as a whole, and your stance will strongly influence others.";
